...
public class ServletFournissantUneInformationALaJSP extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("uneCle", "TOTO");
		RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/modules/modules3/demonstrations/jspAffichantInformationFournieParServlet.jsp");
